...
/skill:dev-vue Create a new component for the sidebar
/skill:dev-optimize-performance The app is running slow
```
...
**Examples:**
```
/force-skill:dev-vue Just need to add a simple button
