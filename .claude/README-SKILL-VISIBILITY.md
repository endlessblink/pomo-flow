...
node .claude/utils/skill-logger.mjs activate dev-debug-reactivity "Debug Vue Reactivity" '{"triggers": ["components won\'t update"]}'
...
├── skills/
│   ├── dev-debug-reactivity/     # Enhanced with visibility
│   │   └── SKILL.md
│   └── [other skills...]
├── templates/
...
Most used skill: dev-debug-reactivity
Skill counts: {
  "dev-debug-reactivity": 6,
  "fix-pinia-state": 4,
  "dev-debug-canvas": 3,
