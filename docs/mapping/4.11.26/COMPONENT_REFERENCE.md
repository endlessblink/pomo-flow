...
- ✅ **RTL Text Support**: Proper handling of Hebrew/Arabic text input
- ✅ **Character Input Fix**: Resolved issue with letter 'f' not working
- ✅ **Vue Lifecycle**: Fixed component lifecycle and initialization errors
- ✅ **Input Validation**: Enhanced character input and validation handling
...
- ✅ **Connection Visualization**: SVG arrow markers and smoothstep curves for clear direction
- ✅ **Drag Separation**: HTML5 drag-and-drop separated from Vue Flow connections
- ✅ **Visual Clarity**: Tasks remain fully visible (opacity: 1) during connection operations
- ✅ **Connection Prevention**: Prevents HTML5 drag interference during Vue Flow connections
- ✅ **Edit Modal Protection**: Fixed modal opening conflicts during task connections
