...
3. **Maintain Backward Compatibility** - Especially for data migrations and task scheduling
4. **Type Safety** - All new code must have proper TypeScript types
5. **Component Structure** - Follow established patterns for script setup, props, and state management
