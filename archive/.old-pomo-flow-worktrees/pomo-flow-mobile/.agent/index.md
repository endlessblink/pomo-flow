...
| Document | Description | Path |
|----------|-------------|------|
| **Board View** | Kanban-style task board with drag-and-drop functionality | `src/views/BoardView.vue` |
| **Calendar View** | Calendar interface for time-based task management | `src/views/CalendarView.vue` |
...
| **Task Column** | Kanban column for task organization | `src/components/kanban/TaskColumn.vue` |
...
| **Settings Modal** | Application settings and preferences | `src/components/SettingsModal.vue` |
...
- ✅ **Board View**: Kanban with swimlanes, drag-drop, project grouping
- ✅ **Calendar View**: Time-based scheduling with drag-create functionality  
