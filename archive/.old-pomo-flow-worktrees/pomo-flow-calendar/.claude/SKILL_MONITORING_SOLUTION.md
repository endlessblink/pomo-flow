...
curl -X POST -H "Content-Type: application/json" \
  -d '{"skill_name":"vue-development","action":"manual","data":{"feature":"component-creation"}}' \
...
node .claude/hooks/skill-monitor-wrapper.js log vue-development --feature component-creation --status success
...
1. **Manual API Calls**:
   ...
   curl -X POST -H "Content-Type: application/json" \
     -d '{"skill_name":"comprehensive-testing","action":"post-skill","data":{"test":"dashboard"}}' \
     http://localhost:6777/mcp/skill-usage
   ```
...
2. **Wrapper Script**:
   ...
   node .claude/hooks/skill-monitor-wrapper.js log comprehensive-testing --test completed --result success
   ```
