...
const filteredTasks = computed(() => {
  try {
    ...
    if (!Array.isArray(storeTasks)) {
      console.warn('CatalogView.filteredTasks: taskStore.filteredTasks is not an array:', storeTasks)
      return []
    }
...
const handleToggleDoneTasks = (event: MouseEvent) => {
  ...
  console.log('🔧 CatalogView: Toggle button clicked!')
  console.log('🔧 CatalogView: Current hideDoneTasks value:', taskStore.hideDoneTasks)
