...
Canvas sections (also called "groups") are interactive containers that automatically update task properties when tasks are dragged into them. This guide explains how the section system works and how to create new sections with custom behavior.
