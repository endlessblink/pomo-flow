...
### 🗃️ Pinia State Management (`pinia-state-management`)
...
### 📅 Calendar/Canvas Integration (`calendar-canvas-integration`)
- Multi-view drag-drop, time slot calculations, canvas interactions
- Event resizing and performance optimization

### 🎨 Canvas Development, Design & Debugging (`debug-canvas-issues`)
