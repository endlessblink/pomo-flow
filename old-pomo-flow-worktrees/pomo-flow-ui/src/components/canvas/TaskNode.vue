...
// Validate that task is not undefined
if (!props.task) {
  console.error('TaskNode: task prop is undefined - this should never happen')
  throw new Error('TaskNode: task prop is required but was undefined')
}
...
const isTimerActive = computed(() => {
  const isActive = timerStore.isTimerActive && timerStore.currentTaskId === props.task.id
  console.log('🍅 DEBUG TaskNode isTimerActive:', {
    taskId: props.task.id,
    taskTitle: props.task.title,
    timerActive: timerStore.isTimerActive,
